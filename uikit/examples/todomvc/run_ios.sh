...
BINARY="$SCRIPT_DIR/../../../target/aarch64-apple-ios-sim/debug/todomvc_ios"
BUNDLE_DIR="$SCRIPT_DIR/bundle/TodoMVC.app"
BUNDLE_ID="com.example.todomvc"
...
<dict>
    ...
    <string>TodoMVC</string>
    <key>CFBundleIdentifier</key>
    <string>com.example.todomvc</string>
...
if [ -z "$DEVICE_ID" ]; then
    ...
    if [ -z "$EXISTING" ]; then
        ...
        EXISTING=$(xcrun simctl create "tmp-counter-$$" "iPhone 16" 2>/dev/null || xcrun simctl create "tmp-counter-$$" com.apple.CoreSimulator.SimDeviceType.iPhone-16)
    fi
