...
BINARY="$SCRIPT_DIR/../../../target/aarch64-apple-ios-sim/debug/settings_ios"
BUNDLE_DIR="$SCRIPT_DIR/bundle/Settings.app"
...
<dict>
    ...
    <string>com.example.settings</string>
