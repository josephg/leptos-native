...
BINARY="$SCRIPT_DIR/../../../target/aarch64-apple-ios-sim/debug/counters_ios"
BUNDLE_DIR="$SCRIPT_DIR/bundle/Counters.app"
BUNDLE_ID="com.example.counters"
...
<dict>
    ...
    <string>com.example.counters</string>
