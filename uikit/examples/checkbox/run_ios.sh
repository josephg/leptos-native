...
BINARY="$SCRIPT_DIR/../../../target/aarch64-apple-ios-sim/debug/checkbox_ios"
BUNDLE_DIR="$SCRIPT_DIR/bundle/Checkbox.app"
...
<dict>
    ...
    <string>com.example.checkbox</string>
