...
impl ToTokens for Model {
    fn to_tokens(&self, tokens: &mut TokenStream) {
        ...
        let output = quote! {
            ...
            #[builder(doc, crate_module_path=::leptos_platform::typed_builder)]
            ...
            /*impl #impl_generics ::leptos_platform::Props for #name #generics #where_clause {
            ...
            impl #impl_generics ::leptos_platform::DynAttrs for #name #generics #where_clause {
                fn dyn_attrs(mut self, v: Vec<(&'static str, ::leptos_platform::Attribute)>) -> Self {
                    #dyn_attrs_props
                    self
                }
            }*/
    ...
    fn to_tokens(&self, tokens: &mut TokenStream) {
        ...
        let into = if self.into {
            if !self.strip_option {
                let ty = &self.ty;
                quote! {
                    fn transform<__IntoReactiveValueMarker>(value: impl ::leptos_platform::prelude::IntoReactiveValue<#ty, __IntoReactiveValueMarker>) -> #ty {
                ...
                quote! {
                    fn transform<__IntoReactiveValueMarker>(value: impl ::leptos_platform::prelude::IntoReactiveValue<#ty, __IntoReactiveValueMarker>) -> Option<#ty> {
