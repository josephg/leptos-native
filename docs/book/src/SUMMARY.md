...
- [Getting Started](./getting_started/README.md)
  - [macOS / Cocoa](./getting_started/macos.md)
  - [Linux / GTK4](./getting_started/gtk.md)
  - [iOS / UIKit](./getting_started/ios.md)
...
- [NodeRef and Directives](./view/10_node_ref.md)
...
- [pop_up_button](./elements/pop_up_button.md)
- [date_picker](./elements/date_picker.md)
- [color_well](./elements/color_well.md)
...
- [macOS / Cocoa](./platform/cocoa/README.md)
  ...
  - [Menus](./platform/cocoa/menus.md)
  - [Toolbar](./platform/cocoa/toolbar.md)
  - [Split View](./platform/cocoa/split_view.md)
  - [SF Symbols](./platform/cocoa/sf_symbols.md)
- [Linux / GTK4](./platform/gtk/README.md)
  - [Application and Windows](./platform/gtk/windows.md)
  - [Menus](./platform/gtk/menus.md)
  - [Settings and Theming](./platform/gtk/settings.md)
- [iOS / UIKit](./platform/ios/README.md)
  - [App Lifecycle](./platform/ios/lifecycle.md)
  - [Safe Area and Keyboard](./platform/ios/safe_area.md)
  - [Building and Launching](./platform/ios/building.md)
  - [Differences from macOS](./platform/ios/deltas.md)

# Appendix

- [How the Reactive System Works](./appendix/reactive_graph.md)
- [Migrating from Web Leptos](./appendix/migration.md)
