...
pub fn open_window(
    ...
    #[cfg(feature = "debug-overlay")]
    {
        ...
        let flipped: &super::flipped_view::FlippedView = any
            .downcast_ref::<super::flipped_view::FlippedView>()
            .expect(
                "debug-overlay: content_root is not a FlippedView — \
                 view tag handling has diverged",
            );
        super::debug_overlay::install(flipped, content_root, mtm);
    }
    ...
    let delegate = WindowDelegate::new(content_root, mtm);
