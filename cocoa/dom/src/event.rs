...
fn ensure_text_field_entry(node: crate::CocoaNode) -> SharedHandlers {
...
fn text_view_for_node(node: crate::CocoaNode) -> Option<Retained<NSTextView>> {
    let view = node.ns_view();
